        ...
        <div className="flex justify-center">
          <div className="relative inline-block">
            <button
              ...
              className=" inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-stroke bg-white dark:bg-gray-800 px-6 py-3 text-base font-medium text-dark dark:border-dark-3 dark:bg-dark-2 dark:text-white"
            >
              Account
              <span
