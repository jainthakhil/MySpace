...
const AccAlreadyExistPopup = () => {
    const firebase = useFirebase()
    const popupContext = usePopUpContext();
    const handleCross = () => {
        popupContext.setAccountAlreadyExist(false);
    }
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="icon-container">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" strokeWidth={0} fill="currentColor" stroke="currentColor" className="icon">
        ...
        <div className="message-text-container">
          ...
          <p className="sub-text">Email is associated with another account,<br /> try using another email.</p>
        </div>
...
export default AccAlreadyExistPopup;
